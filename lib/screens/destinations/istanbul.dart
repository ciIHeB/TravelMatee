...
class DestinationDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     ...
     bool isFavorite = favoritesProvider.isFavorite("istnbul");
...
"Discover Istanbul's charm with luxury accommodations, stunning Bosphorus views, and world-class dining. Relax at the spa or explore the city's vibrant culture—your perfect escape awaits.",
                    style: TextStyle(fontSize: 16),
                  ),
                  SizedBox(height: 20),
                ],
            ...
            Center(
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.pushNamed(context, '/booking', arguments: {'basePrice': 100.0}, );
                },
                child: Container(
